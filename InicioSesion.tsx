...
export default function InicioSesion() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert("¡Login exitoso! (Aquí redirigirías a la página principal)");
    } catch (err) {
  ...
  return (
    <div className="min-h-screen flex w-full bg-white font-sans text-slate-900">
      ...
      {/* --- LADO DERECHO (Imagen y Testimonio) --- */}
        ...
        <div className="relative z-10 flex flex-col justify-end p-16 w-full text-white">
          <div className="mb-8">
            ...
            <blockquote className="text-2xl font-medium leading-snug mb-6">
              "Esta plataforma ha transformado por completo la forma en que
              nuestro equipo colabora y gestiona sus proyectos diarios.
